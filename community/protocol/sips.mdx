---
title: Swarms Improvement Proposals (SIPs)
description: A simplified process for proposing new functionality and enhancements to the Swarms framework.
icon: "lightbulb"
---
...
**Abstract** (200 words max) — A brief summary of what you're proposing and why.
...
Copy this template when creating your SIP:
...
- **Discord**: Join [our community](https://discord.gg/EamjgSaEQf) for real-time help

<Note>
This process is designed to be lightweight while ensuring important changes get proper community review. For questions about whether your idea needs a SIP, start a discussion in the GitHub Discussions forum.
</Note>
